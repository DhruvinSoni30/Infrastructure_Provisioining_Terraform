...
resource "aws_launch_template" "master-custom-launch-template" {
  ...
  user_data               = filebase64("/Users/dhruvins/Desktop/Splunk_Infrastructure_Ansible/bin/master.sh")
...
resource "aws_launch_template" "idx-custom-launch-template" {
  ...
  key_name                = var.key_name
  user_data               = filebase64("/Users/dhruvins/Desktop/Splunk_Infrastructure_Ansible/bin/client.sh")
  update_default_version  = true
  disable_api_termination = true
